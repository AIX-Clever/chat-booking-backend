...
class TestStateTransition:
    ...
    def test_valid_transition_without_required_fields(self):
        ...
        transition = StateTransition(
            ConversationState.INIT, ConversationState.SERVICE_PENDING
        )
...
class TestChatFSM:
    ...
    def test_can_transition_valid_path(self):
        ...
        can_transition, error = ChatFSM.can_transition(
            conversation, ConversationState.SERVICE_PENDING
        )
    ...
    def test_can_transition_invalid_path(self):
        ...
        can_transition, error = ChatFSM.can_transition(
            conversation, ConversationState.BOOKING_CONFIRMED
        )
    ...
    def test_get_required_fields(self):
        ...
        fields = ChatFSM.get_required_fields(
            ConversationState.SERVICE_PENDING, ConversationState.SERVICE_SELECTED
        )
    ...
    def test_validate_context_valid(self):
        ...
        is_valid, error = ChatFSM.validate_context(
            ConversationState.CONFIRM_PENDING, context
        )
...
class TestResponseBuilder:
    ...
    def test_provider_selection_message(self):
        ...
        providers = [
            {"providerId": "pro_1", "name": "John Doe", "bio": "Expert therapist"}
        ]
    ...
    def test_success_message(self):
        ...
        booking = {"bookingId": "bkg_123", "clientEmail": "john@example.com"}
