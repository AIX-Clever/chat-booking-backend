...
from shared.domain.entities import Tenant, TenantId, Workflow, WorkflowStep
from shared.infrastructure.dynamodb_repositories import DynamoDBTenantRepository, DynamoDBWorkflowRepository
    ...
    try:
        ...
        try:
            ...
            if not existing_flows and DEFAULT_FLOW:
                logger.info(f"Tenant {tenant_id_str} has no workflows. Self-healing with default flow.")
                ...
                new_workflow = Workflow(
                    ...
                    description=DEFAULT_FLOW.get("description", "Auto-created by system"),
                    is_active=True,
                    steps=steps,
                    metadata={},
                ...
                logger.info(f"Created default workflow {new_workflow.workflow_id} for tenant {tenant.tenant_id}")
